...
namespace TransitApp.iOS
{
	...
	partial class FuleReport
	{
		...
		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UIPickerView PickerFuelType { get; set; }

		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UIToolbar toolbarFuelstatus { get; set; }
		...
		void ReleaseDesignerOutlets ()
		{
			...
			if (PickerFuelType != null) {
				PickerFuelType.Dispose ();
				PickerFuelType = null;
			}
			if (toolbarFuelstatus != null) {
				toolbarFuelstatus.Dispose ();
				toolbarFuelstatus = null;
			}
			if (txtAmount != null) {
				txtAmount.Dispose ();
				txtAmount = null;
