...
namespace TransitApp.iOS
{
	...
	{
		public event EventHandler<CLLocationUpdatedEventArgs> LocationUpdated = delegate { };
			...
			if (CLLocationManager.LocationServicesEnabled) {
				...
				if (UIDevice.CurrentDevice.CheckSystemVersion (6, 0)) {
					...
					LocMgr.LocationsUpdated += (object sender, CLLocationsUpdatedEventArgs e) => {
						...
						//this.LocationUpdated (this, new CLLocationUpdatedEventArgs (e.Locations [e.Locations.Length - 1]));
					};
					...
					LocMgr.UpdatedLocation += (object sender, CLLocationUpdatedEventArgs e) => {
						this.LocationUpdated (this, new CLLocationUpdatedEventArgs (e.NewLocation,e.OldLocation));
					};
				}
		...
		public void PrintLocation (object sender, CLLocationUpdatedEventArgs e) 
		{
